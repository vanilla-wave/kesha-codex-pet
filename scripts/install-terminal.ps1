...
$sourceDirectory = Join-Path $repositoryRoot 'pet-terminal'
...
$destinationDirectory = Join-Path (Join-Path $codexHome 'pets') 'kesha-terminal'
...
Write-Host "Kesha (Terminal) was installed to $destinationDirectory"
Write-Host 'Open an interactive Codex CLI session, run /pets, and choose Kesha (Terminal).'
